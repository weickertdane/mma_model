...
log_file_path_test_test = 'models/logs/create_projections.log'
logging.basicConfig(filename=log_file_path_test_test, level=logging.INFO, format='%(asctime)s - %(levelname)s - %(message)s')
